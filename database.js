const allTests = {
    ...
    test2: [
        ...
        { q: "Identify the TRUE statement with respect to information provided in the disclosure document of a portfolio management scheme (PMS).", o: ["Information in disclosure document depends on agreement", "Information specified by regulations", "Information specified by stock exchanges", "Information decided by each PMS provider"], a: "Information in the disclosure document of a PMS is specified by the regulations", e: "The Portfolio Manager is required by regulations to provide a Disclosure Document containing specified particulars. [cite: 1]" },
        ...
        { q: "On whom are the SEBI Anti-Money laundering guidelines applicable?", o: ["Intermediaries with products but not liabilities", "Intermediaries in stock markets", "Intermediaries receiving/paying funds", "All SEBI registered intermediaries"], a: "Its applicable to all SEBI registered intermediaries", e: "SEBI AML standards apply to all intermediaries registered with the board. [cite: 1]" },
        ...
        { q: "Identify the important function(s) of the banking system in an economy?", o: ["Guarantees funds", "Provides returns to investors", "Provides credit at efficient cost", "All of the above"], a: "The banking system provides credit at efficient cost for economic activities", e: "Banks act as intermediaries to provide credit at reasonable and efficient costs to seekers. [cite: 1]" },
        { q: "When are the terms of a Forward contract agreed upon?", o: ["Settlement date", "Date they enter into contract", "Expiration date", "First day of financial year"], a: "On the date they enter into the forward contract", e: "Terms for a forward contract are decided 'today'—the date the parties enter into the contract. [cite: 1]" },
        { q: "What is the primary benefit of the foreign exchange market to an importer?", o: ["Speculation to reduce costs", "Hedge risk of currency movement", "Exploit arbitrage", "All of the above"], a: "The importer can hedge the risk of currency movement on price of imports", e: "FX markets allow importers to hedge against the risk of adverse currency movements. [cite: 1]" },
        ...
        { q: "In what way does the secondary market price affect primary market capital raising?", o: ["Indication of price level for new capital", "Promoters sell shares to raise funds", "No effect on capital raising"], a: "The price of the equity shares in the secondary market is an indication at which price level new capital can be raised", e: "The secondary market provides price identification that supports capital raising in the primary market. [cite: 1]" },
        ...
        { q: "Is an adviser helping in platform selection for execution ethical?", o: ["Ethical as it helps investor", "Ethical if adviser has own platform", "Unethical as it shifts responsibility", "Unethical per IA regulations"], a: "Its not an ethical action as the regulations do not permit the investment adviser to be part of the execution process", e: "SEBI IA regulations require strict segregation between advisory and execution activities. [cite: 1]" },
        ...
        { q: "Is ethics just following legal requirements?", o: ["Correct", "Incorrect - legal is complex", "Incorrect - ethics deals with morals", "Incorrect - must follow all laws"], a: "Incorrect as ethics is more than just legal requirements and deals with morals and values to", e: "Ethics involves principles and values that often go beyond basic legal compliance. [cite: 1]" },
        ...
        { q: "In an 'Ethical dilemma', what is the nature of the options?", o: ["Any suitable", "All proper", "All lead to some violation", "No implications"], a: "All the options are such that they would lead to some ethical violation", e: "An ethical dilemma involves choosing between alternatives that both involve some form of violation. [cite: 1]" },
        ...
        { q: "If you can't sell 10,000 shares when volume is 800, this is ________ risk.", o: ["Market", "Sector specific", "Transactional", "Liquidity"], a: "Liquidity risk", e: "Liquidity risk is the inability to find buyers or sellers for a position quickly at the market price. [cite: 1]" },
        ...
        { q: "Which AIF category is permitted to employ leverage?", o: ["Category I", "Category II", "Category III", "None"], a: "Category III AIF", e: "Category III AIFs are uniquely permitted to use leverage for complex trading strategies. [cite: 1]" },
        { q: "Can a person seek exemption from penalties for fraud if they didn't gain?", o: ["No - regulation doesn't require gain", "No - benefits could materialize later", "Yes - if victim waives", "Yes - if no personal benefit"], a: "No, as the regulation does not require a gain to establish fraud", e: "Under SEBI FUTP regulations, fraud is established by the act and intent, regardless of whether a gain occurred. [cite: 1]" },
        ...
        { q: "What describes the core activity of a Private Equity (PE) fund?", o: ["Early-stage funding", "Later-stage business funding", "Publicly traded firm focus", "Providing loans"], a: "Funding later-stage businesses", e: "PE funds primarily invest in established, later-stage companies for expansion or restructuring. [cite: 1]" },
        ...
        { q: "At what price can investors buy listed closed-end units after the NFO?", o: ["Lower than NAV", "Higher than NAV", "Traded prices (higher or lower than NAV)", "Cannot be bought"], a: "The units can be bought at traded prices and these can be lower or higher than the Net Asset Value", e: "Listed closed-end units trade on an exchange at market prices that may reflect a premium or discount to NAV. [cite: 1]" },
        { q: "What is the minimum AIF scheme corpus as per SEBI?", o: ["Rs 5 crore", "Rs 10 crore", "Rs 15 crore", "Rs 20 crore"], a: "Rs. 20 crores", e: "SEBI requires each scheme of an Alternative Investment Fund to have a minimum corpus of at least Rs. 20 crores. [cite: 1]" },
        { q: "Diversification has the biggest impact on ________ risk.", o: ["Company specific", "Market", "Transactional", "All"], a: "Company specific risk", e: "Company-specific (unsystematic) risk is unique to a firm and can be offset through diversification. [cite: 1]" },
